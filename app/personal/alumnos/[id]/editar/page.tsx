...
export default async function EditarAlumnoPage({
  ...
  async function updateStudent(formData: FormData) {
    ...
    const scheduleType = String(
      formData.get("schedule_type") || "jornada_completa"
    );
    ...
    const medicationAuthorization =
      formData.get("medication_authorization") === "on";
    ...
    if (error) {
      console.error(error);
      redirect(`/personal/alumnos/${id}/editar?error=1`);
    }

    redirect(`/personal/alumnos/${id}?updated=1`);
  }
        ...
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-slate-600">
              Modifica la ficha de {student.first_name} {student.last_name}.
            </p>
          </div>
        ...
        <form action={updateStudent} className="space-y-6">
          <section className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <select
                  name="gender"
                  defaultValue={student.gender || "no_especificado"}
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
                >
          ...
          <section className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <select
                  name="classroom_id"
                  defaultValue={student.classroom_id || ""}
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
                >
              ...
              <div>
                ...
                <input
                  name="academic_year"
                  defaultValue={student.academic_year || "2025-2026"}
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
                />
              </div>
              ...
              <div>
                ...
                <select
                  name="status"
                  defaultValue={student.status || "activo"}
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
                >
          ...
          <section className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <div className="mb-5">
              ...
              <select
                name="schedule_type"
                defaultValue={student.schedule_type || "jornada_completa"}
                className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-sky-500"
              >
            ...
            <div className="grid gap-3 md:grid-cols-3">
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="usual_lunch"
                  type="checkbox"
                  defaultChecked={student.usual_lunch || false}
                  className="mr-2"
                />
                Comedor habitual
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="usual_morning_care"
                  type="checkbox"
                  defaultChecked={student.usual_morning_care || false}
                  className="mr-2"
                />
                Matinera habitual
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="usual_afternoon_care"
                  type="checkbox"
                  defaultChecked={student.usual_afternoon_care || false}
                  className="mr-2"
                />
                Tarde habitual
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="swimming"
                  type="checkbox"
                  defaultChecked={student.swimming || false}
                  className="mr-2"
                />
                Piscina NeoKids
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="english_club"
                  type="checkbox"
                  defaultChecked={student.english_club || false}
                  className="mr-2"
                />
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-3">
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  ...
                  type="checkbox"
                  defaultChecked={student.image_authorization || false}
                  className="mr-2"
                />
                Autoriza imagen
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  ...
                  type="checkbox"
                  defaultChecked={student.outing_authorization || false}
                  className="mr-2"
                />
                Autoriza salidas
              </label>
              ...
              <label className="rounded-2xl border border-slate-200 p-4 text-sm font-semibold">
                <input
                  name="medication_authorization"
                  type="checkbox"
                  defaultChecked={student.medication_authorization || false}
                  className="mr-2"
                />
                Autoriza medicación
              </label>
